...
export const metadata: Metadata = {
  title: "Social — The Fairway Standard",
};
  ...
  return (
    <div className="min-h-[calc(100vh-65px)] bg-brand-cream">
      <div className="mx-auto max-w-4xl px-6 py-12">
        <h1 className="font-display text-2xl font-bold text-brand-charcoal">Social</h1>
        <p className="mt-2 text-brand-muted">Connect and grow your presence. More coming soon.</p>
      </div>
    </div>
  );
}
