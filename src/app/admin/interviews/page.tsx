              ...
              interviews.map((interview) => (
                <tr key={interview.id}>
                  ...
                  <td className="px-4 py-3">
                    <span className="rounded-full bg-fairway-50 px-2.5 py-0.5 text-xs font-semibold capitalize text-fairway-700">
                  ...
                  <td className="px-4 py-3">
                    {interview.status === "completed" && (
                      <Link
                        ...
                        className="text-sm font-medium text-fairway-600 hover:text-fairway-800"
                      >
                        Read Transcript
                      </Link>
                    )}
