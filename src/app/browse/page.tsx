    ...
    <div className="min-h-[calc(100vh-65px)]">
      <div className="border-b border-brand-border bg-white">
        <div className="mx-auto max-w-6xl px-6 py-10 sm:py-14">
          <ScrollReveal>
            <p className="font-display text-sm tracking-[0.25em] text-brand-gold-500 uppercase">Browse</p>
              ...
              {[
                ...
                <Link
                  ...
                  className={`rounded-lg px-4 py-2 text-sm font-medium transition ${
                    filter === tab.value
                      ? "bg-brand-green-600 text-white shadow-md shadow-brand-green-600/25"
        ...
        {providers.length > 0 ? (
              ...
              return (
                <StaggerItem key={provider.id}>
                  <Link
                    ...
                    className="group flex h-full flex-col rounded-xl border border-brand-border bg-white shadow-sm transition duration-300 hover:border-brand-gold-300 hover:shadow-lg hover:-translate-y-1"
                  >
                    <div className="p-6 pb-0">
                      <div className="flex items-start gap-4">
                        {provider.avatar_url ? (
                          <img src={provider.avatar_url} alt={provider.full_name} className="h-14 w-14 rounded-full object-cover ring-2 ring-brand-border transition group-hover:ring-brand-gold-300" />
                        ) : (
                          <div className="flex h-14 w-14 items-center justify-center rounded-full bg-gradient-to-br from-brand-green-500 to-brand-green-700 text-xl font-bold text-white ring-2 ring-brand-green-100">
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="flex items-center gap-2">
                            ...
                            {provider.verified && (
                              <span className="flex h-4 w-4 items-center justify-center rounded-full bg-gradient-to-br from-brand-gold-400 to-brand-gold-600 text-white">
          ...
          <ScrollReveal>
            <div className="mt-8 rounded-xl border-2 border-dashed border-brand-border p-16 text-center">
              ...
              <Link href="/join" className="mt-6 inline-block rounded-lg bg-gradient-to-r from-brand-green-600 to-brand-green-500 px-6 py-3 text-sm font-semibold text-white shadow-md transition hover:shadow-lg">
